export function Category() {
  return (
    <div className="grid 2xl:grid-cols-2 xl:grid-cols-1 whitespace-nowrap overflow-auto rounded bg-lightv1 dark:bg-darkv3 border-2 px-6 p-5 dark:border-darkv1 relative caret-lightv1/50 gap-2">
